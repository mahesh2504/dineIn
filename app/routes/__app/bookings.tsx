...
function ReservationRow({
  ...
  const [isItemsModalOpen, handleItemsModal] = useDisclosure(false)
  ...
  return (
    <>
      ...
      <Drawer
        padding={2}
        opened={isItemsModalOpen}
        onClose={() => handleItemsModal.close()}
        title="Billed Items"
        position="right"
        overlayBlur={1.2}
        overlayOpacity={0.6}
